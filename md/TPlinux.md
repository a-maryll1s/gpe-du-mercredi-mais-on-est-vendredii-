...
- ls
- (mkdir ./Dossier1)
- ls => on remarque que `Dossier1` a été ajouté, surligner en vert comme les autres dossiers.
- cd ./Dossier1
- pwd
- touch fic1.txt
- cd /workspaces/gpe-du-mercredi-mais-on-est-vendredii-/
- ls -F => ça affiche des `/` entre les dossiers 
- cp Dossier1/fic1.txt ./Dossier1/fic2.txt
